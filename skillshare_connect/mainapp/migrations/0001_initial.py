# Generated by Django 4.2.23 on 2025-08-25 04:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year_of_study', models.CharField(blank=True, choices=[('1st Year', '1st Year'), ('2nd Year', '2nd Year'), ('3rd Year', '3rd Year'), ('4th Year', '4th Year'), ('Graduate', 'Graduate')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Technical', 'Technical'), ('Creative', 'Creative'), ('Language', 'Language'), ('Other', 'Other')], max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Session',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='review', to='mainapp.session')),
            ],
        ),
        migrations.CreateModel(
            name='UserSkill',
